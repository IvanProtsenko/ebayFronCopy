...
export default class TransactionReserved extends Component {
  state = {
    chatId: '',
    conversations: [],
    advert: null,
  ...
  async componentDidMount() {
    const conversations = await apiService.getConversationsByStatus('Оплачено');
    this.setState(() => {
